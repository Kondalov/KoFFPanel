...
public interface ISingBoxUserManagerService
{
    ...
    // Protocol flags: isVless, isHy2, isTuic, isTrojan
    Task<(bool IsSuccess, string Message, string VlessLink)> AddUserAsync(ISshService ssh, string serverIp, string name, long trafficLimitBytes, DateTime? expiryDate, bool isP2PBlocked = true, bool isVless = true, bool isHy2 = true, bool isTuic = true, bool isTrojan = false);
    ...
    Task<bool> UpdateUserLimitsAsync(ISshService ssh, string serverIp, string name, long newLimitBytes, DateTime? newExpiryDate, string note, bool isP2PBlocked = true, bool isVless = true, bool isHy2 = true, bool isTuic = true, bool isTrojan = false);
