...
public interface IServerMonitorService
{
    ...
    Task<(int Cpu, int Ram, int Ssd, string Uptime, string LoadAvg, string NetworkSpeed, int XrayProcesses, int TcpConnections, int SynRecv)> GetResourcesAsync(ISshService sshService);
